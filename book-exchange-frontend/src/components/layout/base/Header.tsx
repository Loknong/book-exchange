      ...
      <div className="md:container  flex items-center justify-between">
        ...
        <div className=" items-center space-x-4 hidden md:flex">
          {menuList.map((menu, index) => (
            ...
            >
              <div className="text-2xl relative">{menu.icon}
        ...
        <div className="flex flex-row items-center gap-2 md:hidden">
          <div className={`md:hidden block ${isSearchActive ? `hidden` : ``}`} onClick={() => setIsSearchActive(!isSearchActive)}>
            <SearchMobile />

          </div>
          <div className={`${isSearchActive ? `top-0 left-0 w-full` : `top-0 left-[100%] w-0`}   absolute  bg-primary min-h-screen whitespace-nowrap transition-all duration-300 z-50 p-4`}>
            <div className="flex justify-between items-center">


              <i className="text-xl" onClick={() => setIsSearchActive(!isSearchActive)}>
                <FaChevronRight />
              </i>
